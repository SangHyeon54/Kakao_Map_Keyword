package com.example.kakaomap_t;
...
import com.example.kakaomap_t.GpsTracker;
...
public class MainActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapReverseGeoCoder.ReverseGeoCodingResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (TextView) findViewById(R.id.textview_main_jsontext);
        mTextView.setText(lat_json);
        ...
        try {
            encode_query = URLEncoder.encode("중국집", "UTF-8");
                ...
                switch (msg.what) {
                    ...
                    case LOAD_SUCCESS:
                        ...
                        try {
                            ...
                            //mainactivity.textviewJSONText.setText(result_json.getJSONArray("documents").getJSONObject(0).getString("place_name"));
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                ...
                switch (msg.what) {
                    ...
                    case LOAD_SUCCESS:
                        ...
                        for (int i = 0; i < result_array.length(); i++) {
                            //마커 표시 코드
                            try {
                                mainactivity.mTextView.append(result_array.getJSONObject(i).getString("place_name") + ", ");
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
